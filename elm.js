...
Elm.Assignment = Elm.Assignment || {};
Elm.Assignment.make = function (_elm) {
   "use strict";
   _elm.Assignment = _elm.Assignment || {};
   if (_elm.Assignment.values)
   return _elm.Assignment.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   model) {
      ...
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                      ,_0: "font-weight"
                                                                      ,_1: "bold"}]))]),
                   _L.fromArray([$Html.text("Assignment")]))
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Issue: ")]))
                                ,A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(model.issue.title)]))]))]));
   });
   var init = F2(function (teamMember,
   issue) {
      return {_: {}
             ,assignee: teamMember
             ,issue: issue};
   ...
   _elm.Assignment.values = {_op: _op
                            ,Model: Model
                            ,init: init
                            ,view: view};
   return _elm.Assignment.values;
...
Elm.DragAndDropEvents = Elm.DragAndDropEvents || {};
Elm.DragAndDropEvents.make = function (_elm) {
   "use strict";
   _elm.DragAndDropEvents = _elm.DragAndDropEvents || {};
   if (_elm.DragAndDropEvents.values)
   return _elm.DragAndDropEvents.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "DragAndDropEvents",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var onDragOver = F2(function (addr,
   message) {
      return function () {
         var options = {_: {}
                       ,preventDefault: true
   ...
   _elm.DragAndDropEvents.values = {_op: _op
                                   ,onDrag: onDrag
...
Elm.Main.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SprintPlanning = Elm.SprintPlanning.make(_elm),
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm),
   $TeamMember = Elm.TeamMember.make(_elm);
   var main = function () {
      var assignments = _L.fromArray([]);
      var david = A3($TeamMember.init,
      "David",
      120,
      _L.fromArray([]));
      var romain = A3($TeamMember.init,
      "Romain",
      20,
      _L.fromArray([]));
      var teamMembers = _L.fromArray([{ctor: "_Tuple2"
                                      ,_0: 0
                                      ,_1: romain}
                                     ,{ctor: "_Tuple2"
                                      ,_0: 1
                                      ,_1: david}]);
      var issue2 = A2($Issue.init,
      "Issue 2",
      20);
      var issue1 = A2($Issue.init,
      "Issue 1",
      40);
      var unassignedIssues = _L.fromArray([issue1
                                          ,issue2]);
      return $StartApp$Simple.start({_: {}
                                    ,model: A3($SprintPlanning.init,
                                    unassignedIssues,
                                    assignments,
                                    teamMembers)
...
Elm.SprintPlanning.make = function (_elm) {
   ...
   if (_elm.SprintPlanning.values)
   return _elm.SprintPlanning.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "SprintPlanning",
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $TeamMember = Elm.TeamMember.make(_elm);
   var removeAssignment = F2(function (unassignedIssue,
   assignments) {
         ...
         return function () {
            ...
            {case "_Tuple2":
               return !_U.eq(_v0._1,
                 unassignedIssue);}
            _U.badCase($moduleName,
            "on line 85, column 28 to 48");
         }();
      },
      assignments);
   });
   var removeIssue = F2(function (removedIssue,
   issues) {
      return A2($List.filter,
      function (i) {
         return !_U.eq(i,
   ...
   var updateAssignments = F3(function (teamMemberID,
   issue,
   assignments) {
      return $List.append(_L.fromArray([{ctor: "_Tuple2"
                                        ,_0: teamMemberID
                                        ,_1: issue}]))(A2($List.filter,
      function (_v4) {
         return function () {
            switch (_v4.ctor)
            {case "_Tuple2":
               return !_U.eq(_v4._1,issue);}
            _U.badCase($moduleName,
            "on line 76, column 30 to 40");
         }();
      },
      assignments));
   });
   ...
   model) {
      return function () {
         switch (action.ctor)
         {case "Drag":
            return _U.replace([["draggedIssue"
                               ,$Maybe.Just(action._0)]],
              model);
            case "DragOver": return model;
            case "DropAndAssign":
            return function () {
                 var _v11 = model.draggedIssue;
                 switch (_v11.ctor)
                 {case "Just":
                    return _U.replace([["assignments"
                                       ,A3(updateAssignments,
                                       action._0,
                                       _v11._0,
                                       model.assignments)]
                                      ,["unassignedIssues"
                                       ,A2(removeIssue,
                                       _v11._0,
                                       model.unassignedIssues)]],
                      model);
                    case "Nothing": return model;}
                 _U.badCase($moduleName,
                 "between lines 57 and 63");
              }();
            case "DropAndUnassign":
            return function () {
                 var _v13 = model.draggedIssue;
                 switch (_v13.ctor)
                 {case "Just":
                    return _U.replace([["assignments"
                                       ,A2(removeAssignment,
   ...
   var DropAndUnassign = {ctor: "DropAndUnassign"};
   ...
   var viewUnassignedIssue = F2(function (address,
   _v15) {
      return function () {
         switch (_v15.ctor)
         {case "_Tuple2":
            return function () {
                 var htmlClasses = _v15._1 ? "unassigned-issue" : "unassigned-issue dragged";
                 return A2($Html.div,
                 _L.fromArray([$Html$Attributes.draggable("true")
                              ,$Html$Attributes.$class(htmlClasses)
                              ,A2($DragAndDropEvents.onDrag,
                              address,
                              Drag(_v15._0))]),
                 _L.fromArray([$Issue.view(_v15._0)]));
              }();}
         _U.badCase($moduleName,
         "between lines 133 and 142");
      }();
   });
   var viewAssignedIssue = F2(function (address,
   issue) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.draggable("true")
   ...
   var getTeamMember = F2(function (model,
   teamMemberID) {
      return $List.head($List.map(function (_v23) {
         return function () {
            switch (_v23.ctor)
            {case "_Tuple2":
               return _v23._1;}
            _U.badCase($moduleName,
            "on line 41, column 30 to 32");
         }();
      })(A2($List.filter,
      function (_v19) {
         return function () {
            ...
            {case "_Tuple2":
               return _U.eq(_v19._0,
                 teamMemberID);}
            _U.badCase($moduleName,
            "on line 40, column 30 to 50");
         }();
      },
      model.teamMembers)));
   });
   var getAssignedIssues = F2(function (model,
   teamMemberID) {
      return $List.map(function (_v31) {
         return function () {
            switch (_v31.ctor)
            {case "_Tuple2":
               return _v31._1;}
            _U.badCase($moduleName,
            "on line 36, column 29 to 30");
         }();
      })(A2($List.filter,
      function (_v27) {
         return function () {
            ...
            {case "_Tuple2":
               return _U.eq(_v27._0,
                 teamMemberID);}
            _U.badCase($moduleName,
            "on line 35, column 30 to 50");
         }();
      },
      model.assignments));
   });
   var viewTeamMember = F3(function (address,
   model,
   _v35) {
      return function () {
         switch (_v35.ctor)
         {case "_Tuple2":
            return function () {
                 var assignedIssues = A2(getAssignedIssues,
                 model,
                 _v35._0);
                 var assignedCapacity = A2($List.foldl,
                 F2(function (x,y) {
                    return x + y;
                 }),
                 0)(A2($List.map,
                 ...
                 assignedIssues));
                 var assignedIssueViews = A2($List.map,
                 viewAssignedIssue(address),
                 assignedIssues);
                 return A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("team-member")
                              ,A2($DragAndDropEvents.onDragOver,
                              address,
                              DragOver)
                              ,A2($DragAndDropEvents.onDrop,
                              address,
                              DropAndAssign(_v35._0))]),
                 _L.fromArray([A3($TeamMember.view,
                 _v35._1,
                 assignedCapacity,
                 assignedIssueViews)]));
              }();}
         _U.badCase($moduleName,
         "between lines 118 and 129");
      }();
   });
   var view = F2(function (address,
   model) {
      return function () {
         var teamMemberViews = A2($List.map,
         A2(viewTeamMember,
         address,
         model),
         model.teamMembers);
         var isDraggedIssue = function (issue) {
            return function () {
               var _v39 = model.draggedIssue;
               switch (_v39.ctor)
               {case "Just":
                  return {ctor: "_Tuple2"
                         ,_0: issue
                         ,_1: _U.eq(_v39._0,issue)};
                  case "Nothing":
                  return {ctor: "_Tuple2"
                         ,_0: issue
                         ,_1: false};}
         ...
         var unassignedIssueViews = A2($List.map,
         viewUnassignedIssue(address),
         A2($List.map,
         isDraggedIssue,
         model.unassignedIssues));
         return A2($Html.div,
         ...
         _L.fromArray([A2($Html.span,
                      ...
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("team-members-box")]),
                      teamMemberViews)
                      ,A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("unassigned-issues-box")
                                   ,A2($DragAndDropEvents.onDragOver,
                                   address,
                                   DragOver)
                                   ,A2($DragAndDropEvents.onDrop,
                      ...
                      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                         ,_0: "font-weight"
                                                                         ,_1: "bold"}]))]),
                      _L.fromArray([$Html.text("Unassigned issues: ")]))]),
                      unassignedIssueViews))]));
      }();
   });
   var init = F3(function (unassignedIssues,
   assignments,
   teamMembers) {
      return {_: {}
             ,assignments: _L.fromArray([])
             ,draggedIssue: $Maybe.Nothing
   ...
   _elm.SprintPlanning.values = {_op: _op
                                ...
                                ,DropAndUnassign: DropAndUnassign
                                ,update: update
                                ...
                                ,viewUnassignedIssue: viewUnassignedIssue
                                ,viewAssignedIssue: viewAssignedIssue};
   return _elm.SprintPlanning.values;
};
...
Elm.TeamMember.make = function (_elm) {
   ...
   if (_elm.TeamMember.values)
   return _elm.TeamMember.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   assignedIssueViews) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Initial capacity: ")]))
                                ,A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text($Basics.toString(model.capacity))]))]))
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Remaining: ")]))
                                ,A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text($Basics.toString(model.capacity - assignedCapacity))]))]))
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([A2($Html.span,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text("Assigned issues: ")]))
                                ,A2($Html.div,
                                _L.fromArray([]),
                                assignedIssueViews)]))]));
   });
   ...
   _elm.TeamMember.values = {_op: _op
                            ,Model: Model
                            ,init: init
                            ,view: view};
   return _elm.TeamMember.values;
